...
// 한 줄 주석 : 컴파일러가 해석하지 않는 부분, 코드 설명 작성
/* 범위 
   주석 */
...
public class JavaTest {
	...
	public static void main(String[] args) {
		// main method : 자바 애플리케이션(프로그램) 실행하기 위해 반드시 필요한 메소드
		...
		System.out.println(673 / 3);
		
		// ""(문자열) + 숫자 함께 작성
		int a = 14 * 19;
		System.out.println("14 * 19 = " + a);
		System.out.println("14 * 19 = " + 14*19);
		System.out.println("90 + 70 + 65 = " + (90 + 70 + 65));
		
		// < + 기호의 역할 >
		// 숫자 + 숫자 = 덧셈의 연산 결과
		// 문자열 + 숫자 or 문자열 + 문자열 = 이어쓰기 효과
